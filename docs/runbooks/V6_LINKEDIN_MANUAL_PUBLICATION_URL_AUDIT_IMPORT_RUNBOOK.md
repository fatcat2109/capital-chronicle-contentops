# V6 LinkedIn Manual Publication URL Audit Import Runbook

Use the canonical V5 dashboard only: `ui/contentops_v5/`.

## Purpose

This lane records an operator-supplied HTTPS LinkedIn post URL as text evidence only. It must not be opened, fetched, scraped, browsed, or network verified.
