# V6 LinkedIn Manual Operator Handoff Runbook

Use the canonical V5 dashboard only: `ui/contentops_v5/`.

## Purpose

This lane binds export and approval/export evidence for operator review. It is manual-copy-only and has no runtime proof.
