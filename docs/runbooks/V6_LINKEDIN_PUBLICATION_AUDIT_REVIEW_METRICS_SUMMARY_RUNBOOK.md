# V6 LinkedIn Publication Audit Review & Manual Metrics Summary Runbook

Use the canonical V5 dashboard only: `ui/contentops_v5/`.

## Purpose

This lane records operator-supplied manual LinkedIn metrics as fixture evidence only. No metrics API, scraping, browser open, or network verification is allowed.
