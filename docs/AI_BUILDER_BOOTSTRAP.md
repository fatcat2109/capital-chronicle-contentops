...
The current reusable learning authority is `TASK_CONTENTOPS_GENERIC_FOUNDATION_V2_AUTHORITY_AND_EVIDENCE_INTEGRITY_REPAIR`. Commit `11124edc623d480736966fa54b44bb6289a935fd` is accepted as `ACCEPT_GENERIC_FOUNDATION_V2_ENFORCEMENT_WITH_AUTHORITY_INTEGRITY_GAPS`; the repair closes those generic trust-boundary gaps without changing the 20 domain specifications, uncalibrated config, accepted release, or historical V1 adapters. Read `docs/architecture/CONTENTOPS_GENERICITY_AND_DOMAIN_GENERALIZATION_STANDARD_V1.md`, the enforcement manifest, and the repair manifest before extending ContentOps intelligence or learning features. The next action is `INDEPENDENT_CHATGPT_AUDIT_GENERIC_FOUNDATION_V2_AUTHORITY_AND_EVIDENCE_INTEGRITY_REPAIR`.
