...
def run():
    target_dir = r"docs\browser_qa\TASK_CONTENTOPS_0174A_OPERATOR_COCKPIT_V2_BROWSER_QA_EVIDENCE_CAPTURE_V0"
    ...
    with open("qa_script_results.json", "w") as f:
        json.dump(results, f, indent=2)
        
    print("Screenshots captured and results saved to qa_script_results.json")
