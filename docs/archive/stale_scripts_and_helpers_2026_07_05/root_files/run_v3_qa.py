...
def run():
    target_dir = r"docs\browser_qa\TASK_CONTENTOPS_0174C_OPERATOR_COCKPIT_V3_VISIBLE_ANTIGRAVITY_BROWSER_QA_V0"
    screenshots_dir = os.path.join(target_dir, "screenshots")
    os.makedirs(screenshots_dir, exist_ok=True)
    
    url = r"file:///A:/Capital%20Chronicle/tools/cc-live-contentops/ui/institutional_operator_cockpit_v3/index.html"
    ...
    with open("qa_script_v3_results.json", "w") as f:
        json.dump(results, f, indent=2)
        
    print("Visible Screenshots captured and results saved to qa_script_v3_results.json")
