# IDE/CLI Quickstart - After TASK_CONTENTOPS_0101
...
## Test commands
- python -m pytest -q
- python -m pytest -q tests/test_pre_alpha_pipeline_demo.py
...
- Read docs under docs/ (start with CURRENT_STATE_SUMMARY_AFTER_0101.md).
