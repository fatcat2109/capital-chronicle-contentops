# Upload Bundle Manifest - After TASK_CONTENTOPS_0112

LOCAL ONLY | SAFE CONTEXT DOCS/SCHEMAS ONLY | NO SECRETS

Bundle name: `project_sources_bundle_AFTER_0112`
...
| --- | --- | --- |
| CURRENT_STATE_SUMMARY_AFTER_0112.md | CURRENT_CONTEXT | SAFE |
| NEW_CHAT_CONTINUATION_AFTER_0112.md | CURRENT_CONTINUATION_CONTEXT | SAFE |
| PROJECT_SOURCE_EXPORT_AFTER_0112.md | EXPORT_GUIDANCE | SAFE |
| UPLOAD_BUNDLE_MANIFEST_AFTER_0112.md | MANIFEST | SAFE |
| IDE_CLI_QUICKSTART_AFTER_0112.md | OPERATIONAL_QUICKSTART | SAFE |
...
| PRE_ALPHA_CONTENT_SEED_LIBRARY_AND_EDITORIAL_CALENDAR_AFTER_0103.md | ADVISORY_CONTEXT | SAFE |
| PRE_ALPHA_OPERATOR_DASHBOARD_PACKET_AFTER_0104.md | ADVISORY_CONTEXT | SAFE |
| PRE_ALPHA_EDITORIAL_BATCH_REVIEW_PACKET_AFTER_0105.md | ADVISORY_CONTEXT | SAFE |
| PRE_ALPHA_MANUAL_DECISION_BATCH_PACKET_AFTER_0106.md | ADVISORY_CONTEXT | SAFE |
| PRE_ALPHA_MANUAL_EXPORT_BATCH_PACKET_AFTER_0107.md | ADVISORY_CONTEXT | SAFE |
| PRE_ALPHA_MANUAL_PUBLISH_RECORD_PACKET_AFTER_0108.md | ADVISORY_CONTEXT | SAFE |
| PRE_ALPHA_PLATFORM_SPECIFIC_MANUAL_EXPORT_TEMPLATES_AFTER_0110.md | ADVISORY_CONTEXT | SAFE |
| PRE_ALPHA_DAILY_OPERATOR_CONTENT_RUN_PACKET_AFTER_0111.md | ADVISORY_CONTEXT | SAFE |
| PRE_ALPHA_DAILY_MANUAL_PUBLISH_RUNBOOK_AFTER_0112.md | ADVISORY_CONTEXT | SAFE |

## Included - schemas (pre_alpha pipeline contracts)
| File | safety |
| --- | --- |
| pre_alpha_content_seed.schema.json | SAFE |
| pre_alpha_content_seed_library.schema.json | SAFE |
| pre_alpha_draft_candidate.schema.json | SAFE |
| pre_alpha_editorial_packet.schema.json | SAFE |
| pre_alpha_editorial_calendar_plan.schema.json | SAFE |
...
| pre_alpha_operator_dashboard_packet.schema.json | SAFE |
| pre_alpha_editorial_batch_review_packet.schema.json | SAFE |
| pre_alpha_manual_decision_batch_packet.schema.json | SAFE |
| pre_alpha_manual_export_batch_packet.schema.json | SAFE |
| pre_alpha_manual_publish_record_packet.schema.json | SAFE |
| pre_alpha_platform_manual_template_packet.schema.json | SAFE |
| pre_alpha_daily_operator_content_run_packet.schema.json | SAFE |
...
- `project_sources_bundle_AFTER_0108/` (stale)
...
## Upload instruction
Upload only the AFTER_0112 bundle files into a new ChatGPT Project Sources set.
Remove older AFTER_0073/AFTER_0074/AFTER_0099/AFTER_0101/AFTER_0108 bundles to
prevent stale-authority drift. The AFTER_0112 bundle supersedes all of them.
