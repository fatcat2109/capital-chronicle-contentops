# Upload Bundle Manifest - After TASK_CONTENTOPS_0099

LOCAL ONLY | SAFE CONTEXT DOCS/SCHEMAS ONLY | NO SECRETS

Bundle name: `project_sources_bundle_AFTER_0099`
Generated location (external, untracked):
`A:\Capital Chronicle\tools\project_sources_bundle_AFTER_0099`
...
| --- | --- | --- |
| CURRENT_STATE_SUMMARY_AFTER_0099.md | CURRENT_CONTEXT | SAFE |
| NEW_CHAT_CONTINUATION_AFTER_0099.md | CURRENT_CONTINUATION_CONTEXT | SAFE |
| PROJECT_SOURCE_EXPORT_AFTER_0099.md | EXPORT_GUIDANCE | SAFE |
| UPLOAD_BUNDLE_MANIFEST_AFTER_0099.md | MANIFEST | SAFE |
| IDE_CLI_QUICKSTART_AFTER_0099.md | OPERATIONAL_QUICKSTART | SAFE |
...
## Upload instruction
Upload only the AFTER_0099 bundle files into a new ChatGPT Project Sources set.
Remove older AFTER_0073/AFTER_0074 bundles to prevent stale-authority drift.
