...
NEXT_RECOMMENDED_TASK = (
    "TASK_CONTENTOPS_0174WS_WT_WU_LEDGER10_EVIDENCE_CLEANUP_AND_LEDGER10_TO_LEDGER11_TWELFTH_SEND_"
    "BATCH_V0"
)
...
def build_artifact_doc(packet):
    ...
    return (
        "# 0174WP/WQ/WR Telegram Ledger-10 Remote Operator Loop State\n\n"
...
def write_artifacts(base_dir, packet, doc):
    ...
    if violations:
        raise RuntimeError(
            "refusing to write ledger10 remote loop artifacts: scan found %d violation(s)" % len(violations))
