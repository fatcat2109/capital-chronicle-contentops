"""V5 Adapter Codegen for Local Canonical Draft Preview and Review."""
...
ADAPTER_PATH = ROOT / "ui/contentops_v5/src/data/localCanonicalDraftPreviewReviewAdapter.ts"
...
def generate_or_check_adapter(verify_only: bool = False) -> dict[str, bool]:
    ...
    content = f"{header}export const localCanonicalDraftPreviewReviewPacket = {json.dumps(packet, indent=2, sort_keys=True)} as const;\n"
