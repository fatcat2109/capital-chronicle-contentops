...
- packet_id: `official_platform_docs_evidence_matrix_packet_4a8720b2ea6a33699fc3727d`
- packet_hash: `4a8720b2ea6a33699fc3727d26c19e755ff1e0ca15f1e3d74a2d31fbf13faf9c`
...
|---|---|---|---|---|---|---|---|
| `x` | `primary_distribution` | `partial_docs_grounded` | `supported_by_cited_doc` | `strong` | OAuth 2.0 Authorization Code Flow with PKCE | v2/tweets POST/GET | Pay-per-use/rate-limit caveat dependent on paid tier |
...
| `youtube` | `later_video_distribution` | `partial_docs_grounded` | `supported_by_cited_doc` | `strong` | Google OAuth 2.0 with client id | YouTube Data API v3 videos.insert | Daily API upload quota consumes 1600 units out of 10000 units |
