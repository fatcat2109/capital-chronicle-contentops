...
- **Packet Hash**: `0d2dddd5b695e6cc909b11fdc3a6e80b8271ad58f71a92b6cbdef69ad25f460d`
- **Global Draft Eligibility Status**: `BLOCKED_DRAFT_ELIGIBILITY_PENDING_OPERATOR_INPUT`
...
|---|---|---|---|---|---|---|
| `draft_eligibility_item_01_intent_item_STEP1_OFFICIAL_TEXT_LIVE_PROBE_MANIFEST_V1` | `supervised_input_stub_01_intent_item_STEP1_OFFICIAL_TEXT_LIVE_PROBE_MANIFEST_V1` | `STEP1_OFFICIAL_TEXT_LIVE_PROBE_MANIFEST_V1` | `BLOCKED_BY_SUPERVISED_INPUT_STUB_CONTRACT` | `False` | `False` | `resolve_supervised_input_stub_contract_requirements` |
| `draft_eligibility_item_02_intent_item_STEP1_OFFICIAL_TEXT_SPINE_CONTRACT_V1` | `supervised_input_stub_02_intent_item_STEP1_OFFICIAL_TEXT_SPINE_CONTRACT_V1` | `STEP1_OFFICIAL_TEXT_SPINE_CONTRACT_V1` | `BLOCKED_BY_SUPERVISED_INPUT_STUB_CONTRACT` | `False` | `False` | `resolve_supervised_input_stub_contract_requirements` |
| `draft_eligibility_item_03_intent_item_BEA_BLS_CENSUS_NORMALIZED_CONTRACT_V1` | `supervised_input_stub_03_intent_item_BEA_BLS_CENSUS_NORMALIZED_CONTRACT_V1` | `BEA_BLS_CENSUS_NORMALIZED_CONTRACT_V1` | `BLOCKED_BY_SUPERVISED_INPUT_STUB_CONTRACT` | `False` | `False` | `resolve_supervised_input_stub_contract_requirements` |
| `draft_eligibility_item_04_intent_item_BEA_BLS_CENSUS_NORMALIZED_CANDIDATE_RECORDS_V1` | `supervised_input_stub_04_intent_item_BEA_BLS_CENSUS_NORMALIZED_CANDIDATE_RECORDS_V1` | `BEA_BLS_CENSUS_NORMALIZED_CANDIDATE_RECORDS_V1` | `BLOCKED_BY_SUPERVISED_INPUT_STUB_CONTRACT` | `False` | `False` | `resolve_supervised_input_stub_contract_requirements` |
| `draft_eligibility_item_05_intent_item_BROKER_PROXY_NO_VALUE_SNAPSHOT_MANIFEST_V1` | `supervised_input_stub_05_intent_item_BROKER_PROXY_NO_VALUE_SNAPSHOT_MANIFEST_V1` | `BROKER_PROXY_NO_VALUE_SNAPSHOT_MANIFEST_V1` | `BLOCKED_BY_SUPERVISED_INPUT_STUB_CONTRACT` | `False` | `False` | `resolve_supervised_input_stub_contract_requirements` |
| `draft_eligibility_item_06_intent_item_DATABASE_FOUNDATION_TTL_FRESHNESS_POLICY_CONTRACT_V1` | `supervised_input_stub_06_intent_item_DATABASE_FOUNDATION_TTL_FRESHNESS_POLICY_CONTRACT_V1` | `DATABASE_FOUNDATION_TTL_FRESHNESS_POLICY_CONTRACT_V1` | `BLOCKED_BY_SUPERVISED_INPUT_STUB_CONTRACT` | `False` | `False` | `resolve_supervised_input_stub_contract_requirements` |
| `draft_eligibility_item_07_intent_item_ECONOMIC_PRINTS_SCHEMA_CONTRACT_V1` | `supervised_input_stub_07_intent_item_ECONOMIC_PRINTS_SCHEMA_CONTRACT_V1` | `ECONOMIC_PRINTS_SCHEMA_CONTRACT_V1` | `BLOCKED_BY_SUPERVISED_INPUT_STUB_CONTRACT` | `False` | `False` | `resolve_supervised_input_stub_contract_requirements` |
...
- `[FORBIDDEN]` actual_draft_generation
...
- **Next Recommended Task**: `TASK_CONTENTOPS_0175BT_DRAFT_ELIGIBILITY_GATE_PRECHECK_TO_V5_READONLY_PRECHECK_PANEL_BINDING_V0`
