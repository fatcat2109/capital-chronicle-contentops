...
Current task: `TASK_CONTENTOPS_NEWSROOM_CANDIDATE_ASSIGNMENT_AND_FIVE_WINDOW_SCHEDULING_V1` — `PASS_NEWSROOM_CANDIDATE_POOL_V1_DETERMINISTIC_CANDIDATE_ONLY`.

Completed architecture authority: `TASK_CONTENTOPS_GENERIC_EVIDENCE_FRESHNESS_VISUAL_EDITORIAL_FABRIC_V2`.

Next route: `TASK_CONTENTOPS_TIER1_EDITORIAL_REVISION_AND_SEO_QUALITY_V2`.
