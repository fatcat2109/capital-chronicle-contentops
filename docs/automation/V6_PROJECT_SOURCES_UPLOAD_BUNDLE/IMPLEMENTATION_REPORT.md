...
- **Task Label**: TASK_CONTENTOPS_V6_CANONICAL_ARTICLE_STUDIO_EDITORIAL_REFINEMENT_QUEUE_DRY_RUN_HEAVY_BATCH_V0
...
- **Generation HEAD (pre-commit generation input only, not runtime authority)**: d898a8420501505a4fa63c57d6a11fb7072b9c1e (requires GitHub audit after push)
