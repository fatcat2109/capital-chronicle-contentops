...
- **Task Label**: TASK_CONTENTOPS_V6_VERIFIED_SOURCE_PACK_IMPORT_AND_REVALIDATION_DRY_RUN_HEAVY_BATCH_V0
...
- **Generation HEAD (pre-commit generation input only, not runtime authority)**: 10d2f5a305e0cfcdbf6479cc71b45b4740790b15 (requires GitHub audit after push)
