...
- **Current generation HEAD (pre-commit generation input only, not runtime authority)**: 3debd0b5840697beeee11b872395e19424c4ac8b (requires GitHub audit after push)
