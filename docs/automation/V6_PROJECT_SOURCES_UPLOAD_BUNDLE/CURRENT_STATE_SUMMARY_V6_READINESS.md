...
- **Current generation HEAD (pre-commit generation input only, not runtime authority)**: 015041217bdfc8e7043c08eb51761ed827d836ee (requires GitHub audit after push)
