...
- **Current generation HEAD (pre-commit generation input only, not runtime authority)**: 408d9c1cce60406638be16068d3d6b1eebd96743 (requires GitHub audit after push)
