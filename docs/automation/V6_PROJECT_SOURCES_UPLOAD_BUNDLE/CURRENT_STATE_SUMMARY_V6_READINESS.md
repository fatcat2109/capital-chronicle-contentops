...
- **Current generation HEAD (pre-commit generation input only, not runtime authority)**: 0e00f6118a89696b5c3fac500eb1acf1d9ec3ce5 (requires GitHub audit after push)
