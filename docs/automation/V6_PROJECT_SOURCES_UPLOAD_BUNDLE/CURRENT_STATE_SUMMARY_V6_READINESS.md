...
- **Current generation HEAD (pre-commit generation input only, not runtime authority)**: 913f1ea1fec74d1eabd3e8218cd15838bd98ae0b (requires GitHub audit after push)
