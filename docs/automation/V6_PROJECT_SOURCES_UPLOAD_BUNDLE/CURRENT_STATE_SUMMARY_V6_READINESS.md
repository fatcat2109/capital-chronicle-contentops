...
- **Current generation HEAD (pre-commit generation input only, not runtime authority)**: 880c54e5da728d582166ed028fb799bfcc6bc929 (requires GitHub audit after push)
