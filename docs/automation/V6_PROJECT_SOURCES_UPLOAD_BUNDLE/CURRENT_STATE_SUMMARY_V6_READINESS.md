...
- **Current generation HEAD (pre-commit generation input only, not runtime authority)**: 663f63aba6bf0ee6de2370a646c82cec0db94bc5 (requires GitHub audit after push)
