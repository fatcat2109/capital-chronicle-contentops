...
- **Upload bundle generation HEAD (pre-commit generation input only, not runtime authority)**: 0f32597cff6aa134771f8f531e52d8019fea568d (requires GitHub audit after push)
