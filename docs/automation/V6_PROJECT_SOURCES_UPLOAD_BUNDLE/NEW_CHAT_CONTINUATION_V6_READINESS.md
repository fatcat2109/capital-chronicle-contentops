...
- **Upload bundle generation HEAD (pre-commit generation input only, not runtime authority)**: 6c6fb2530a7df5958931b267169dfad4b981284b (requires GitHub audit after push)
