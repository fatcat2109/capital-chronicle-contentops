...
- **Upload bundle generation HEAD (pre-commit generation input only, not runtime authority)**: 8cdc886aa76fcadae0acdd9953ea12a3e0e3efb9 (requires GitHub audit after push)
