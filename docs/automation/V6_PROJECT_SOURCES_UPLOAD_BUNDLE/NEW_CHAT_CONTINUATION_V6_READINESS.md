...
- **Upload bundle generation HEAD (pre-commit generation input only, not runtime authority)**: 55f1e5d64e0404114e69e1439954befbb9516dc5 (requires GitHub audit after push)
