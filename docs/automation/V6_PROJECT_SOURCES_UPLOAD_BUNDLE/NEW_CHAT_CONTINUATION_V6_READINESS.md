...
- **Upload bundle generation HEAD (pre-commit generation input only, not runtime authority)**: 16818332d83b949aef60dfb32be0f0df09ccb527 (requires GitHub audit after push)
