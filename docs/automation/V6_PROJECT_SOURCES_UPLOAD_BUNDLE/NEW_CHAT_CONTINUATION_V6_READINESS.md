...
- **Upload bundle generation HEAD (pre-commit generation input only, not runtime authority)**: 83973cad43d826600a297f4f6458b998af0f49c5 (requires GitHub audit after push)
