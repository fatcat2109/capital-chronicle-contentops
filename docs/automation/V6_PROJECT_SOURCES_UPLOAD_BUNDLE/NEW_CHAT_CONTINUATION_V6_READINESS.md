...
- **Upload bundle generation HEAD (pre-commit generation input only, not runtime authority)**: 1b55a5f786021ee34b32ecece12be37a44f66620 (requires GitHub audit after push)
