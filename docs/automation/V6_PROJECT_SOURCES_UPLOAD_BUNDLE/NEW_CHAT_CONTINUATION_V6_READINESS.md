...
- **Upload bundle generation HEAD (pre-commit generation input only, not runtime authority)**: df6a9220097c20535b83ce796c31ddeae007db1d (requires GitHub audit after push)
