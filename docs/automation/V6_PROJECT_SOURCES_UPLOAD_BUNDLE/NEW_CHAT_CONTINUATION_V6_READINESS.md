...
- **Upload bundle generation HEAD (pre-commit generation input only, not runtime authority)**: 332e64626255171c59a525352f01659379e5c0f2 (requires GitHub audit after push)
