...
The latest official Treasury curve sits above the previous session at the long end. Source: [U.S. Treasury daily par yield curve](https://home.treasury.gov/resource-center/data-chart-center/interest-rates/TextView?type=dailytreasuryyieldcurve). Capital Chronicle chart.
...
Selected entries from the official July 13 Treasury table, with previous-session comparisons calculated by Capital Chronicle. Source: [Treasury XML data](https://home.treasury.gov/resource-center/data-chart-center/interest-rates/pages/xml?data=dailytreasuryyieldcurve&fieldtdrdatevalue=2026).
...
This analysis uses the official July 13 close rather than a live quote. It does not infer moves in other assets without separate market data, and the curve should be treated as one input into a broader market assessment.

Sources and Method

The yield levels come from the [U.S. Treasury Daily Treasury Par Yield Curve Rates](https://home.treasury.gov/resource-center/data-chart-center/interest-rates/TextView?type=dailytreasuryyieldcurve) and its [official XML data](https://home.treasury.gov/resource-center/data-chart-center/interest-rates/pages/xml?data=dailytreasuryyieldcurve&fieldtdrdatevalue=2026). Methodology context comes from the Treasury's [interest-rate statistics page](https://home.treasury.gov/policy-issues/financing-the-government/interest-rate-statistics). Capital Chronicle produced the charts and calculated the 2s10s spread from same-date official observations. This article is for informational purposes only and is not financial advice.
