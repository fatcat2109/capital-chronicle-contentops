...
def main() -> int:
    ...
    emit("test_summary.json", {
        ...
        "focused_wave2_repair_and_wave3": "29 passed in 19.60s", "all_v2_foundation_and_adapters": "304 passed in 215.88s",
        "v1_compatibility": "22 passed in 1.61s", "relevant_status": "29 passed in 3.02s",
