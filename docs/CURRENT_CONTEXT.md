...
Archives are rollback/reference only. Read them only when current authority links an exact historical evidence path or when a current audit requires a unique prior run artifact.
