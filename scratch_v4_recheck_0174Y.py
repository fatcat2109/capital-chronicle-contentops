...
def run():
    target_dir = r"scratch\v4_recheck_0174Y"
    ...
    with sync_playwright() as p:
        ...
        # Settings -> Evidence Vault
        page.click("text=Evidence Vault")
        page.screenshot(path=os.path.join(target_dir, "1366x768_evidence_vault.png"), full_page=True)
        
        # Publish Readiness Tower
        page.click("text=Publish Readiness Tower")
        page.screenshot(path=os.path.join(target_dir, "1366x768_publish_readiness.png"), full_page=True)
        
        # Content Studio
        page.click("text=Content Studio")
        page.screenshot(path=os.path.join(target_dir, "1366x768_content_studio.png"), full_page=True)
        
        # Command Center
        page.click("text=Command Center")
        page.screenshot(path=os.path.join(target_dir, "1366x768_command_center.png"), full_page=True)
        
        # 1920x1080 (Command Center)
