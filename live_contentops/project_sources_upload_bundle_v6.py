...
TASK_LABEL = "TASK_CONTENTOPS_V6_NEXT_ARTICLE_PLANNING_PACKET_FROM_FEEDBACK_CONTRACT_DRY_RUN_HEAVY_BATCH_V0"
...
NEXT_PROJECT_SOURCES_REFRESH_AND_UPLOAD_BUNDLE_TASK = "TASK_CONTENTOPS_V6_PROJECT_SOURCES_REFRESH_AND_UPLOAD_BUNDLE_AFTER_V6_LOOP_CONTRACTS_V0"
...
NEXT_CANONICAL_ARTICLE_STUDIO_SOURCE_APPROVED_DRAFT_RENDERER_TASK = "TASK_CONTENTOPS_V6_CANONICAL_ARTICLE_STUDIO_SOURCE_APPROVED_DRAFT_RENDERER_DRY_RUN_HEAVY_BATCH_V0"
NEXT_CANONICAL_ARTICLE_STUDIO_EDITORIAL_REFINEMENT_QUEUE_TASK = "TASK_CONTENTOPS_V6_CANONICAL_ARTICLE_STUDIO_EDITORIAL_REFINEMENT_QUEUE_DRY_RUN_HEAVY_BATCH_V0"
NEXT_CANONICAL_ARTICLE_STUDIO_SEO_METADATA_CONTRACT_TASK = "TASK_CONTENTOPS_V6_CANONICAL_ARTICLE_STUDIO_SEO_METADATA_CONTRACT_DRY_RUN_HEAVY_BATCH_V0"
...
NEXT_OUTBOX_ENTRY_CONTRACT_TASK = "TASK_CONTENTOPS_V6_OUTBOX_ENTRY_CONTRACT_DRY_RUN_HEAVY_BATCH_V0"
NEXT_SUPERVISED_DISPATCH_CONTRACT_TASK = "TASK_CONTENTOPS_V6_SUPERVISED_DISPATCH_CONTRACT_DRY_RUN_HEAVY_BATCH_V0"
...
def materialize_project_sources_upload_bundle_packets(
    ...
    upload_candidate_files = [
        ...
        "docs/automation/V6_CANONICAL_DRAFT_FROM_APPROVED_REDACTED_SOURCE_PACK/canonical_draft_eligibility_packet.json",
        "docs/automation/V6_CANONICAL_DRAFT_FROM_APPROVED_REDACTED_SOURCE_PACK/test_only_approved_redacted_source_pack_summary.json",
        "docs/automation/V6_CANONICAL_DRAFT_FROM_APPROVED_REDACTED_SOURCE_PACK/canonical_draft_claim_eligibility_matrix.json",
        "docs/automation/V6_CANONICAL_DRAFT_FROM_APPROVED_REDACTED_SOURCE_PACK/canonical_draft_generation_blocked_preview.md",
        "docs/automation/V6_CANONICAL_DRAFT_FROM_APPROVED_REDACTED_SOURCE_PACK/canonical_draft_eligibility_validation_report.json",
        "docs/automation/V6_CANONICAL_DRAFT_FROM_APPROVED_REDACTED_SOURCE_PACK/canonical_draft_eligibility_blocker_report.md",
        "docs/automation/V6_CANONICAL_DRAFT_FROM_APPROVED_REDACTED_SOURCE_PACK/canonical_draft_eligibility_runbook.md",
        "docs/automation/V6_CANONICAL_DRAFT_FROM_APPROVED_REDACTED_SOURCE_PACK/implementation_report.md",
        "docs/automation/V6_CANONICAL_DRAFT_FROM_APPROVED_REDACTED_SOURCE_PACK/next_task_pointer.md",
        "docs/automation/V6_CANONICAL_ARTICLE_STUDIO_REVIEW_QUEUE/canonical_article_studio_queue_packet.json",
        "docs/automation/V6_CANONICAL_ARTICLE_STUDIO_REVIEW_QUEUE/canonical_article_studio_review_item.json",
        "docs/automation/V6_CANONICAL_ARTICLE_STUDIO_REVIEW_QUEUE/canonical_article_studio_editor_checklist.json",
        "docs/automation/V6_CANONICAL_ARTICLE_STUDIO_REVIEW_QUEUE/canonical_article_studio_review_queue_validation_report.json",
        "docs/automation/V6_CANONICAL_ARTICLE_STUDIO_REVIEW_QUEUE/canonical_article_studio_local_mock.html",
        "docs/automation/V6_CANONICAL_ARTICLE_STUDIO_REVIEW_QUEUE/canonical_article_studio_screenshot_manifest.json",
        ...
        "docs/automation/V6_CANONICAL_ARTICLE_STUDIO_PLACEHOLDER_BINDING/canonical_article_studio_placeholder_binding_packet.json",
        "docs/automation/V6_CANONICAL_ARTICLE_STUDIO_PLACEHOLDER_BINDING/canonical_article_studio_slot_binding_map.json",
        "docs/automation/V6_CANONICAL_ARTICLE_STUDIO_PLACEHOLDER_BINDING/canonical_article_studio_placeholder_binding_review.json",
        "docs/automation/V6_CANONICAL_ARTICLE_STUDIO_PLACEHOLDER_BINDING/canonical_article_studio_placeholder_bound_shell_instance.json",
        "docs/automation/V6_CANONICAL_ARTICLE_STUDIO_PLACEHOLDER_BINDING/canonical_article_studio_placeholder_binding_validation_report.json",
        "docs/automation/V6_CANONICAL_ARTICLE_STUDIO_PLACEHOLDER_BINDING/canonical_article_studio_placeholder_binding_blocker_report.md",
        "docs/automation/V6_CANONICAL_ARTICLE_STUDIO_PLACEHOLDER_BINDING/canonical_article_studio_placeholder_binding_runbook.md",
        "docs/automation/V6_CANONICAL_ARTICLE_STUDIO_PLACEHOLDER_BINDING/implementation_report.md",
        "docs/automation/V6_CANONICAL_ARTICLE_STUDIO_PLACEHOLDER_BINDING/next_task_pointer.md",
        "docs/automation/V6_CANONICAL_ARTICLE_STUDIO_SOURCE_APPROVED_RENDERER/canonical_article_studio_renderer_gate_packet.json",
        "docs/automation/V6_CANONICAL_ARTICLE_STUDIO_SOURCE_APPROVED_RENDERER/canonical_article_studio_renderer_input_contract.json",
        "docs/automation/V6_CANONICAL_ARTICLE_STUDIO_SOURCE_APPROVED_RENDERER/canonical_article_studio_blocked_renderer_output.json",
        "docs/automation/V6_CANONICAL_ARTICLE_STUDIO_SOURCE_APPROVED_RENDERER/canonical_article_studio_renderer_slot_status_matrix.json",
        "docs/automation/V6_CANONICAL_ARTICLE_STUDIO_SOURCE_APPROVED_RENDERER/canonical_article_studio_renderer_validation_report.json",
        "docs/automation/V6_CANONICAL_ARTICLE_STUDIO_SOURCE_APPROVED_RENDERER/canonical_article_studio_renderer_blocker_report.md",
        "docs/automation/V6_CANONICAL_ARTICLE_STUDIO_SOURCE_APPROVED_RENDERER/canonical_article_studio_renderer_runbook.md",
        "docs/automation/V6_CANONICAL_ARTICLE_STUDIO_SOURCE_APPROVED_RENDERER/implementation_report.md",
        "docs/automation/V6_CANONICAL_ARTICLE_STUDIO_SOURCE_APPROVED_RENDERER/next_task_pointer.md",
        "docs/automation/V6_CANONICAL_ARTICLE_STUDIO_EDITORIAL_REFINEMENT_QUEUE/canonical_article_studio_refinement_queue_packet.json",
        "docs/automation/V6_CANONICAL_ARTICLE_STUDIO_EDITORIAL_REFINEMENT_QUEUE/canonical_article_studio_refinement_input_contract.json",
        "docs/automation/V6_CANONICAL_ARTICLE_STUDIO_EDITORIAL_REFINEMENT_QUEUE/canonical_article_studio_blocked_refinement_output.json",
        "docs/automation/V6_CANONICAL_ARTICLE_STUDIO_EDITORIAL_REFINEMENT_QUEUE/canonical_article_studio_refinement_slot_status_matrix.json",
        "docs/automation/V6_CANONICAL_ARTICLE_STUDIO_EDITORIAL_REFINEMENT_QUEUE/canonical_article_studio_refinement_checklist.json",
        "docs/automation/V6_CANONICAL_ARTICLE_STUDIO_EDITORIAL_REFINEMENT_QUEUE/canonical_article_studio_refinement_validation_report.json",
        "docs/automation/V6_CANONICAL_ARTICLE_STUDIO_EDITORIAL_REFINEMENT_QUEUE/canonical_article_studio_refinement_blocker_report.md",
        "docs/automation/V6_CANONICAL_ARTICLE_STUDIO_EDITORIAL_REFINEMENT_QUEUE/canonical_article_studio_refinement_runbook.md",
        "docs/automation/V6_CANONICAL_ARTICLE_STUDIO_EDITORIAL_REFINEMENT_QUEUE/implementation_report.md",
        "docs/automation/V6_CANONICAL_ARTICLE_STUDIO_EDITORIAL_REFINEMENT_QUEUE/next_task_pointer.md",
        "docs/automation/V6_CANONICAL_ARTICLE_STUDIO_SEO_METADATA_CONTRACT/canonical_article_studio_seo_metadata_packet.json",
        "docs/automation/V6_CANONICAL_ARTICLE_STUDIO_SEO_METADATA_CONTRACT/canonical_article_studio_seo_input_contract.json",
        "docs/automation/V6_CANONICAL_ARTICLE_STUDIO_SEO_METADATA_CONTRACT/canonical_article_studio_blocked_seo_output.json",
        "docs/automation/V6_CANONICAL_ARTICLE_STUDIO_SEO_METADATA_CONTRACT/canonical_article_studio_seo_field_status_matrix.json",
        "docs/automation/V6_CANONICAL_ARTICLE_STUDIO_SEO_METADATA_CONTRACT/canonical_article_studio_seo_checklist.json",
        "docs/automation/V6_CANONICAL_ARTICLE_STUDIO_SEO_METADATA_CONTRACT/canonical_article_studio_seo_metadata_validation_report.json",
        "docs/automation/V6_CANONICAL_ARTICLE_STUDIO_SEO_METADATA_CONTRACT/canonical_article_studio_seo_metadata_blocker_report.md",
        "docs/automation/V6_CANONICAL_ARTICLE_STUDIO_SEO_METADATA_CONTRACT/canonical_article_studio_seo_metadata_runbook.md",
        "docs/automation/V6_CANONICAL_ARTICLE_STUDIO_SEO_METADATA_CONTRACT/implementation_report.md",
        "docs/automation/V6_CANONICAL_ARTICLE_STUDIO_SEO_METADATA_CONTRACT/next_task_pointer.md",
        "docs/automation/V6_PLATFORM_VARIANT_INPUT_CONTRACT_QUEUE/platform_variant_queue_packet.json",
        "docs/automation/V6_PLATFORM_VARIANT_INPUT_CONTRACT_QUEUE/platform_variant_input_contract.json",
        "docs/automation/V6_PLATFORM_VARIANT_INPUT_CONTRACT_QUEUE/platform_variant_blocked_output.json",
        "docs/automation/V6_PLATFORM_VARIANT_INPUT_CONTRACT_QUEUE/platform_variant_readiness_matrix.json",
        "docs/automation/V6_PLATFORM_VARIANT_INPUT_CONTRACT_QUEUE/platform_variant_checklist.json",
        "docs/automation/V6_PLATFORM_VARIANT_INPUT_CONTRACT_QUEUE/platform_variant_queue_validation_report.json",
        "docs/automation/V6_PLATFORM_VARIANT_INPUT_CONTRACT_QUEUE/platform_variant_blocker_report.md",
        "docs/automation/V6_PLATFORM_VARIANT_INPUT_CONTRACT_QUEUE/platform_variant_runbook.md",
        "docs/automation/V6_PLATFORM_VARIANT_INPUT_CONTRACT_QUEUE/implementation_report.md",
        "docs/automation/V6_PLATFORM_VARIANT_INPUT_CONTRACT_QUEUE/next_task_pointer.md",
        "docs/automation/V6_PLATFORM_VARIANT_RENDERER_BLOCKED_OUTPUT/platform_variant_renderer_packet.json",
        "docs/automation/V6_PLATFORM_VARIANT_RENDERER_BLOCKED_OUTPUT/platform_variant_renderer_input_contract.json",
        "docs/automation/V6_PLATFORM_VARIANT_RENDERER_BLOCKED_OUTPUT/platform_variant_renderer_blocked_output.json",
        "docs/automation/V6_PLATFORM_VARIANT_RENDERER_BLOCKED_OUTPUT/platform_variant_renderer_matrix.json",
        "docs/automation/V6_PLATFORM_VARIANT_RENDERER_BLOCKED_OUTPUT/platform_variant_renderer_checklist.json",
        "docs/automation/V6_PLATFORM_VARIANT_RENDERER_BLOCKED_OUTPUT/platform_variant_renderer_validation_report.json",
        ...
        "docs/automation/V6_APPROVAL_QUEUE_EXACT_PAYLOAD_REVIEW_CONTRACT/approval_queue_exact_payload_review_packet.json",
        "docs/automation/V6_APPROVAL_QUEUE_EXACT_PAYLOAD_REVIEW_CONTRACT/approval_queue_exact_payload_review_input_contract.json",
        "docs/automation/V6_APPROVAL_QUEUE_EXACT_PAYLOAD_REVIEW_CONTRACT/approval_queue_blocked_review_template.json",
        "docs/automation/V6_APPROVAL_QUEUE_EXACT_PAYLOAD_REVIEW_CONTRACT/approval_queue_blocked_review_output.json",
        "docs/automation/V6_APPROVAL_QUEUE_EXACT_PAYLOAD_REVIEW_CONTRACT/approval_queue_review_gate_matrix.json",
        "docs/automation/V6_APPROVAL_QUEUE_EXACT_PAYLOAD_REVIEW_CONTRACT/approval_queue_review_checklist.json",
        "docs/automation/V6_APPROVAL_QUEUE_EXACT_PAYLOAD_REVIEW_CONTRACT/approval_queue_review_validation_report.json",
        "docs/automation/V6_APPROVAL_QUEUE_EXACT_PAYLOAD_REVIEW_CONTRACT/approval_queue_review_blocker_report.md",
        "docs/automation/V6_APPROVAL_QUEUE_EXACT_PAYLOAD_REVIEW_CONTRACT/approval_queue_review_runbook.md",
        "docs/automation/V6_APPROVAL_QUEUE_EXACT_PAYLOAD_REVIEW_CONTRACT/implementation_report.md",
        "docs/automation/V6_APPROVAL_QUEUE_EXACT_PAYLOAD_REVIEW_CONTRACT/next_task_pointer.md",
        "docs/automation/V6_OUTBOX_ENTRY_CONTRACT/outbox_entry_packet.json",
        "docs/automation/V6_OUTBOX_ENTRY_CONTRACT/outbox_entry_input_contract.json",
        "docs/automation/V6_OUTBOX_ENTRY_CONTRACT/outbox_entry_blocked_template.json",
        "docs/automation/V6_OUTBOX_ENTRY_CONTRACT/outbox_entry_blocked_output.json",
        "docs/automation/V6_OUTBOX_ENTRY_CONTRACT/outbox_entry_gate_matrix.json",
        "docs/automation/V6_OUTBOX_ENTRY_CONTRACT/outbox_entry_checklist.json",
        "docs/automation/V6_OUTBOX_ENTRY_CONTRACT/outbox_entry_validation_report.json",
        "docs/automation/V6_OUTBOX_ENTRY_CONTRACT/outbox_entry_blocker_report.md",
        "docs/automation/V6_OUTBOX_ENTRY_CONTRACT/outbox_entry_runbook.md",
        "docs/automation/V6_OUTBOX_ENTRY_CONTRACT/implementation_report.md",
        "docs/automation/V6_OUTBOX_ENTRY_CONTRACT/next_task_pointer.md",
        "docs/automation/V6_SUPERVISED_DISPATCH_CONTRACT/supervised_dispatch_packet.json",
        "docs/automation/V6_SUPERVISED_DISPATCH_CONTRACT/supervised_dispatch_input_contract.json",
        "docs/automation/V6_SUPERVISED_DISPATCH_CONTRACT/supervised_dispatch_blocked_template.json",
        "docs/automation/V6_SUPERVISED_DISPATCH_CONTRACT/supervised_dispatch_blocked_output.json",
        "docs/automation/V6_SUPERVISED_DISPATCH_CONTRACT/supervised_dispatch_gate_matrix.json",
        "docs/automation/V6_SUPERVISED_DISPATCH_CONTRACT/supervised_dispatch_checklist.json",
        "docs/automation/V6_SUPERVISED_DISPATCH_CONTRACT/supervised_dispatch_validation_report.json",
        "docs/automation/V6_SUPERVISED_DISPATCH_CONTRACT/supervised_dispatch_blocker_report.md",
        "docs/automation/V6_SUPERVISED_DISPATCH_CONTRACT/supervised_dispatch_runbook.md",
        "docs/automation/V6_SUPERVISED_DISPATCH_CONTRACT/implementation_report.md",
        "docs/automation/V6_SUPERVISED_DISPATCH_CONTRACT/next_task_pointer.md",
        "docs/automation/V6_PUBLICATION_AUDIT_RECORD_CONTRACT/publication_audit_record_packet.json",
        "docs/automation/V6_PUBLICATION_AUDIT_RECORD_CONTRACT/publication_audit_record_input_contract.json",
        "docs/automation/V6_PUBLICATION_AUDIT_RECORD_CONTRACT/publication_audit_record_blocked_template.json",
        "docs/automation/V6_PUBLICATION_AUDIT_RECORD_CONTRACT/publication_audit_record_blocked_output.json",
        "docs/automation/V6_PUBLICATION_AUDIT_RECORD_CONTRACT/publication_audit_record_gate_matrix.json",
        "docs/automation/V6_PUBLICATION_AUDIT_RECORD_CONTRACT/publication_audit_record_checklist.json",
        "docs/automation/V6_PUBLICATION_AUDIT_RECORD_CONTRACT/publication_audit_record_validation_report.json",
        "docs/automation/V6_PUBLICATION_AUDIT_RECORD_CONTRACT/publication_audit_record_blocker_report.md",
        "docs/automation/V6_PUBLICATION_AUDIT_RECORD_CONTRACT/publication_audit_record_runbook.md",
        "docs/automation/V6_PUBLICATION_AUDIT_RECORD_CONTRACT/implementation_report.md",
        "docs/automation/V6_PUBLICATION_AUDIT_RECORD_CONTRACT/next_task_pointer.md",
        "docs/automation/V6_COMMUNITY_FEEDBACK_CAPTURE_CONTRACT/community_feedback_capture_packet.json",
        "docs/automation/V6_COMMUNITY_FEEDBACK_CAPTURE_CONTRACT/community_feedback_capture_input_contract.json",
        "docs/automation/V6_COMMUNITY_FEEDBACK_CAPTURE_CONTRACT/community_feedback_capture_blocked_template.json",
        "docs/automation/V6_COMMUNITY_FEEDBACK_CAPTURE_CONTRACT/community_feedback_capture_blocked_output.json",
        "docs/automation/V6_COMMUNITY_FEEDBACK_CAPTURE_CONTRACT/community_feedback_capture_gate_matrix.json",
        "docs/automation/V6_COMMUNITY_FEEDBACK_CAPTURE_CONTRACT/community_feedback_capture_checklist.json",
        "docs/automation/V6_COMMUNITY_FEEDBACK_CAPTURE_CONTRACT/community_feedback_capture_validation_report.json",
        ...
        "docs/automation/V6_NEXT_ARTICLE_PLANNING_FROM_FEEDBACK_CONTRACT/next_article_planning_from_feedback_packet.json",
        "docs/automation/V6_NEXT_ARTICLE_PLANNING_FROM_FEEDBACK_CONTRACT/next_article_planning_from_feedback_input_contract.json",
        "docs/automation/V6_NEXT_ARTICLE_PLANNING_FROM_FEEDBACK_CONTRACT/next_article_planning_blocked_template.json",
        "docs/automation/V6_NEXT_ARTICLE_PLANNING_FROM_FEEDBACK_CONTRACT/next_article_planning_blocked_output.json",
        "docs/automation/V6_NEXT_ARTICLE_PLANNING_FROM_FEEDBACK_CONTRACT/next_article_planning_gate_matrix.json",
        "docs/automation/V6_NEXT_ARTICLE_PLANNING_FROM_FEEDBACK_CONTRACT/next_article_planning_checklist.json",
        "docs/automation/V6_NEXT_ARTICLE_PLANNING_FROM_FEEDBACK_CONTRACT/next_article_planning_validation_report.json",
        "docs/automation/V6_NEXT_ARTICLE_PLANNING_FROM_FEEDBACK_CONTRACT/next_article_planning_blocker_report.md",
        "docs/automation/V6_NEXT_ARTICLE_PLANNING_FROM_FEEDBACK_CONTRACT/next_article_planning_runbook.md",
        "docs/automation/V6_NEXT_ARTICLE_PLANNING_FROM_FEEDBACK_CONTRACT/implementation_report.md",
        "docs/automation/V6_NEXT_ARTICLE_PLANNING_FROM_FEEDBACK_CONTRACT/next_task_pointer.md"
    ]
    ...
    packet = {
        ...
        "next_recommended_task": NEXT_PROJECT_SOURCES_REFRESH_AND_UPLOAD_BUNDLE_TASK
    }
