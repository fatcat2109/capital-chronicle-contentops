"""V5 Adapter Codegen for Platform Variant Final Review and Approval Packet Preview."""
...
def generate_or_check_adapter(verify_only: bool = False) -> dict[str, bool]:
    ...
    content = f"{header}export const platformVariantApprovalPacketPreviewPacket = {json.dumps(packet, indent=2, sort_keys=True)} as const;\n"
