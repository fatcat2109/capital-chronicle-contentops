...
def _audit_entries(review,loop):
    ...
    b=audit.build_redacted_ledger_entry(entry_sequence=2,previous_entry_hash=a.entry_hash,entry_family="editorial_feedback_loop",source_model="0174UD",source_model_version=MODEL_VERSION,payload=_asdict(loop),created_at_epoch=review.reviewed_at_epoch+1)
    return a,b
