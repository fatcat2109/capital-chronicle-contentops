...
window.CC_INSTITUTIONAL_SHELL_FIXTURE = {
  ...
  global_state: {
    ...
    branch_label: "master",
    accepted_head_short: "444ef2c",
    accepted_head_note: "latest accepted code baseline after 0168 (current global state)",
    historical_view_model_baseline: "15b87ff (0159 view-model contract; historical lineage, not current)",
    ...
    historical_gate_note: "telegram_official_docs_credential_validation_gate was a prior gate; historical, not current",
    latest_browser_qa_evidence: "0169 PASS_WITH_MINOR_EVIDENCE_GAP (evidence-only browser QA)",
    next_allowed_action: "AWAIT OPERATOR/CHATGPT AUDIT OF 0170 EVIDENCE BEFORE PROJECT SOURCES REFRESH OR ANY NEXT TASK",
    next_allowed_action_code: "AWAIT_OPERATOR/CHATGPT_AUDIT_OF_0170_EVIDENCE_BEFORE_PROJECT_SOURCES_REFRESH_OR_ANY_NEXT_TASK",
    active_blockers: [],
    evidence_count: 12,
