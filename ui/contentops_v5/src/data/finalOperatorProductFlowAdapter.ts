...
const platformUniverse = [
  ...
  platform('facebook', 'Facebook Page', 'Meta-family page distribution lane', 'Official REST API post/comment', 'review', 'Submit approved variant via Graph API after Jim approval.', 'facebook_page_preview', 'page_post', '1200x627 report card or reviewed news metadata candidate.', 'graph_api_audit_log', 'manual_review_only'),
  platform('threads', 'Threads', 'Meta-family short-form conversation lane', 'Official REST API post/comment', 'review', 'Submit approved thread via Threads API after Jim approval.', 'threads_preview', 'short_conversation', 'Square report card fits; threads split enabled.', 'threads_api_audit_log', 'manual_review_only'),
  platform('instagram', 'Instagram', 'Visual/social media lane', 'Official REST API media container publish', 'review', 'Publish image container via Graph API after Jim approval.', 'instagram_caption_preview', 'visual_caption', 'Built-in square card required for internal reports.', 'graph_api_audit_log', 'manual_review_only'),
...
const manualDeferredRows = [
  manualDeferredRow(platformUniverse[5], 'facebook', 'manual_handoff_only', 'Meta-family Facebook Page lane is supported via official Graph API; Page/API posting is active.', 'Submit approved variant via Graph API after Jim approval.', 'Graph API audit log recorded; fallback to Meta Business Suite available.'),
  manualDeferredRow(platformUniverse[6], 'threads', 'manual_handoff_only', 'Threads lane is supported via official Threads API; API posting and replies are active.', 'Submit approved thread via Threads API after Jim approval.', 'Threads API audit log recorded; fallback to manual copy available.'),
  manualDeferredRow(platformUniverse[7], 'instagram', 'manual_handoff_only', 'Instagram is supported via official Graph API; container creation and media publishing are active.', 'Publish image container via Graph API after Jim approval.', 'Graph API media audit log recorded; fallback to manual copy available.'),
