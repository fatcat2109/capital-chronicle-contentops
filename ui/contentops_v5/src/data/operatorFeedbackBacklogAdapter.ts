// V6 Operator-supplied feedback backlog adapter.
// Generated from committed local/manual-only packets; no network/env/browser/provider access.

export const operatorSuppliedFeedbackIntakePacket = {
  "accepted_manual_platforms": [
    "Substack",
    "LinkedIn",
    "X"
  ],
  "audit_index_hash": "b968984b920bbf93edef7941ab3c93f229db393f6be7bcf0025a713b82cc5477",
  "audit_index_packet_id": "manual_distribution_registry_audit_index_b968984b920bbf93",
  "browser_session_used": false,
  "credential_read_made": false,
  "env_value_read_made": false,
  "exact_payload_hash": "4b0ff2791a5398184621325ba8ce5fe843963cbc826885e29eb823f5a05e7dd4",
  "feedback_count": 4,
  "feedback_intake_packet_id": "operator_supplied_feedback_intake_4b0ff2791a539818",
  "feedback_items": [
    {
      ...
      "source_scraped": false,
      "source_url_hash_optional": "7a2be8e6fbbfb0d21c9d6fa93335e4349c0838528d75b84e1f3fb1786698c48d",
      "source_url_network_verified": false,
    ...
    },
    {
      ...
      "source_scraped": false,
      "source_url_hash_optional": "ef94d26d87eccf5c9678d93b079a4f36e2706fa016d4b7f499d3122e8d99ade5",
      "source_url_network_verified": false,
    ...
    },
    {
      ...
      "source_platform": "x",
      "source_scraped": false,
      "source_url_hash_optional": "27a5df0cbb562e675f9b39b660978913d60835342520784035776cab28f85123",
      "source_url_network_verified": false,
...
export const operatorFeedbackBacklogSummaryPacket = {
  "audit_index_hash": "b968984b920bbf93edef7941ab3c93f229db393f6be7bcf0025a713b82cc5477",
  "audit_index_packet_id": "manual_distribution_registry_audit_index_b968984b920bbf93",
  "backlog_candidates": [
    {
    ...
    },
    {
      ...
      "readiness_status": "ready_for_operator_review_only",
      "source_feedback_item_ids": [
        "operator_feedback_manual_note_001"
      ],
      "source_platforms": [
        "manual_note"
      ],
    ...
    },
    {
      ...
      "readiness_status": "ready_for_operator_review_only",
      "source_feedback_item_ids": [
        "operator_feedback_linkedin_comment_001"
      ],
      "source_platforms": [
        "linkedin"
      ],
  ...
  "backlog_summary_packet_id": "operator_feedback_backlog_summary_24b783562e91a600",
  "blocked_controls": [
    "approve",
    "dispatch",
    "publish",
  ...
  "credential_read_made": false,
  "env_value_read_made": false,
  "exact_payload_hash": "24b783562e91a600284c252c85a4e6757e11b1030743850869ef6d39c93addd8",
  "feedback_count": 4,
  "feedback_intake_hash": "4b0ff2791a5398184621325ba8ce5fe843963cbc826885e29eb823f5a05e7dd4",
  "feedback_intake_packet_id": "operator_supplied_feedback_intake_4b0ff2791a539818",
  "live_publish_performed_by_contentops": false,
  "llm_provider_call_made": false,
  "network_call_made": false,
