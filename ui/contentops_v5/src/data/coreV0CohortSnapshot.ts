...
export const coreV0CohortSnapshot = {
  ...
  "calibration_policy_id": "CONTENTOPS_CORE_V0_SHADOW_SELECTION_CALIBRATION_V1",
  "calibration_policy_logical_hash": "6a2506014d7edeb2e2ade0cdf97060149685754bad103f0e10332b22be1ccdf0",
  "calibration_policy_operating_mode_ceiling": "SHADOW_ONLY",
  ...
  "cases": [
    {
      ...
      "base_score_authority": null,
      "base_score_calibration_state": null,
      "base_score_source": "universal_news_candidate_fabric_v2.score_candidate",
      "calibration_policy_id": null,
      "calibration_policy_logical_hash": null,
    ...
    },
    {
      ...
      "base_score_authority": null,
      "base_score_calibration_state": null,
      "base_score_source": "owner_authorized_shadow_calibration_v1.governed_packet_claim_counts",
      "calibration_policy_id": null,
      "calibration_policy_logical_hash": null,
  ...
  "concentration_penalties": [
    {
      ...
      "base_rank": 3,
      "base_score": 30.0,
      "base_score_authority": "OWNER_AUTHORIZED_PROVISIONAL_CALIBRATION_POLICY",
      "base_score_source": "owner_authorized_shadow_calibration_v1.governed_packet_claim_counts",
      "case_id": "case-regulation-joint-rule",
      "concentration_penalty": 12.0,
      "disposition": "SELECTED",
    ...
    },
    {
      ...
      "base_rank": 2,
      "base_score": 66.66666667,
      "base_score_authority": "ACCEPTED_GOVERNED_CANDIDATE_SCORER",
      "base_score_source": "universal_news_candidate_fabric_v2.score_candidate",
      "case_id": "case-economic-release-ust-newsroom",
      "concentration_penalty": 60.0,
      "disposition": "SELECTED",
  ...
  "portfolio_daily": {
    ...
    "candidate_event_time_max_utc": "2026-07-15T22:30:00Z",
    "candidate_event_time_min_utc": "2026-05-01T00:00:00Z",
    "case_count": 5,
  ...
  "portfolio_decision": {
    ...
    "calibration_policy_version": "v1",
    "concentration_threshold": 0.34,
    "decision_logical_hash": "4e1193055ae3ffae824d4ec0f41cab69067b11b40c37893fc75981b6663c784c",
    "decision_window_id": "2026-07-15",
    "decisions": [
      {
        "adjusted_rank": 1,
        ...
        "base_score": 30.0,
        "base_score_authority": "OWNER_AUTHORIZED_PROVISIONAL_CALIBRATION_POLICY",
        "base_score_calibration_state": "OWNER_AUTHORIZED_PROVISIONAL_SHADOW_CALIBRATION_V1",
        "base_score_source": "owner_authorized_shadow_calibration_v1.governed_packet_claim_counts",
        "calibration_policy_authorized_for_live_publication": false,
        "calibration_policy_id": "CONTENTOPS_CORE_V0_SHADOW_SELECTION_CALIBRATION_V1",
        "calibration_policy_logical_hash": "6a2506014d7edeb2e2ade0cdf97060149685754bad103f0e10332b22be1ccdf0",
      ...
      },
      {
        ...
        "base_score": 66.66666667,
        "base_score_authority": "ACCEPTED_GOVERNED_CANDIDATE_SCORER",
        "base_score_calibration_state": "UNCALIBRATED_FOUNDATION",
        "base_score_source": "universal_news_candidate_fabric_v2.score_candidate",
        "calibration_policy_authorized_for_live_publication": false,
        "calibration_policy_id": "CONTENTOPS_CORE_V0_SHADOW_SELECTION_CALIBRATION_V1",
        "calibration_policy_logical_hash": "6a2506014d7edeb2e2ade0cdf97060149685754bad103f0e10332b22be1ccdf0",
  ...
  "selection_calibration_effective_values": {
    ...
    "overridden_for_this_run": {
      "concentration_penalty_per_concentrated_value": false,
      "portfolio_balance_floor": false,
      "rolling_concentration_threshold": false
    },
    "portfolio_balance_floor": 0.0,
    "rolling_concentration_threshold": 0.34
  },
  "selection_calibration_integrity": {
    "integrity_verified": true,
    "policy_id": "CONTENTOPS_CORE_V0_SHADOW_SELECTION_CALIBRATION_V1",
    "policy_logical_hash": "6a2506014d7edeb2e2ade0cdf97060149685754bad103f0e10332b22be1ccdf0"
  },
  "selection_calibration_policy": {
    "authority_date": "2026-08-06",
    ...
    "live_use_prohibition": "This calibration is authorized for shadow evaluation only. It must not decide live publication or public-write eligibility without a later explicit owner decision issued as a new policy version.",
    "operating_mode_ceiling": "SHADOW_ONLY",
    "owner": "Jim (product owner)",
