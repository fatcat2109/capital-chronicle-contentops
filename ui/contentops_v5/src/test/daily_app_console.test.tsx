...
function snapshot(overrides: Partial<DailyAppSnapshot> = {}): DailyAppSnapshot {
  const base: DailyAppSnapshot = {
    ...
    today: { current_cycle: null, pending_lifecycle_recovery_count: 1, immediate_incident_count: 1, published_today_count: 0, published_corpus_count: 0, daily_target_band: [5, 8] },
