...
- Annotated tag `v1.0` exists at immutable release commit `6983bfb3ef300414b744f3f8f97ca81ff699348b`; the release is operator accepted. The reusable backend foundation is now the generic V2 authority-and-evidence integrity repair over the enforcement hardening; the current next action is the independent audit named in `next_task_pointer.md`.
