...
class DeterministicFakeProvider:
        ...
        *,
        ...
        if ambiguous_after_transfer:
            ...
            return {
                ...
                "readback_discovered_object": readback_discovers_object,
        ...
        return {
            "blind_retry_blocked": False,
            "readback_discovered_object": True,
            "reconciliation_matched": result.matched,
            "receipt": attempt.to_receipt(),
        }
    ...
    def _initial_refs(attempt: PublicationAttempt, object_id: str) -> dict[str, str]:
        if attempt.binding.surface is Surface.TIKTOK:
            return {"publish_id": f"v_pub_file~v2.{object_id}", "provider_object_id": object_id}
    ...
    def _published_readback(
        ...
        if surface is Surface.TIKTOK:
            ...
            return {
                "creator_info": {
                    "creator_username": binding.expected_identity_id,
                    "creator_nickname": binding.expected_public_handle,
                    "privacy_level_options": ["PUBLIC_TO_EVERYONE", "SELF_ONLY"],
                    "max_video_post_duration_sec": 180,
                },
                "status": {
                    "status": "PUBLISH_COMPLETE",
                    "publicaly_available_post_id": [object_id],
                },
                "video": {
                    "id": object_id,
                    "title": caption,
        ...
        if surface in {Surface.INSTAGRAM_REELS, Surface.INSTAGRAM_STORIES}:
            media: dict[str, Any] = {
                ...
                "permalink": f"https://www.instagram.com/{'reel' if surface is Surface.INSTAGRAM_REELS else 'stories'}/{object_id}/",
            }
