...
def test_status_last_updated_and_accepted_task_are_consistent_after_metadata_repair():
    ...
    assert status["current_product_phase"] == "TASK 0098 Final release go/no-go rehearsal, end-to-end evidence audit, and operator release handoff verification completed with PASS verdict."
