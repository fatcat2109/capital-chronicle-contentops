...
def test_status_last_updated_and_accepted_task_are_consistent_after_metadata_repair():
    ...
    assert status["current_product_phase"] == "Final release go/no-go rehearsal refreshed with idempotent release evidence, red-team/governance posture, status guardrails, and canonical V5 validation"
