...
def test_status_last_updated_and_accepted_task_are_consistent_after_metadata_repair():
    ...
    assert status["current_product_phase"] == "TASK 0100 Final release go/no-go rehearsal completed with release evidence, red-team, governance, and canonical V5 validation"
