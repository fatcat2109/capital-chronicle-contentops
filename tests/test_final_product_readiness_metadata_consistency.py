...
def test_status_records_database_authorized_generic_canary_authority() -> None:
    ...
    assert status["current_task_classification"] == "PASS_PRODUCTION_ADAPTER_WAVE_3_AND_WAVE_2_CONTRACT_REPAIR_V1_AWAITING_CHATGPT_AUDIT"
    ...
    assert status["next_task"] == "INDEPENDENT_CHATGPT_AUDIT_PRODUCTION_ADAPTER_WAVE_3_AND_WAVE_2_CONTRACT_REPAIR_V1"
