...
def test_status_last_updated_and_accepted_task_are_consistent_after_metadata_repair():
    ...
    assert status["current_product_phase"] == "TASK 0101 Operator maintenance and post-release governance completed with telemetry, platform capability, stale artifact, and status-ledger audits"
