...
from live_contentops.x_manual_approval_export_evidence_v6 import build_x_manual_approval_export_evidence_packet
def test_x_approval_evidence_binds_export():
    export=load('docs/automation/V6_X_MANUAL_EXPORT/sample_x_manual_export_packet.json')
    p=load('docs/automation/V6_X_MANUAL_APPROVAL_EXPORT_EVIDENCE/sample_x_manual_approval_export_evidence_packet.json')
    assert build_x_manual_approval_export_evidence_packet(export)==p
