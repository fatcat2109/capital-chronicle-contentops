...
def test_metadata_integrity_and_hardenings(tmp_path):
    ...
    assert packet["task_label"] == "TASK_CONTENTOPS_V6_PLATFORM_VARIANT_APPROVAL_PACKET_CONTRACT_DRY_RUN_HEAVY_BATCH_V0"
    ...
    assert packet["next_recommended_task"] == "TASK_CONTENTOPS_V6_APPROVAL_QUEUE_EXACT_PAYLOAD_REVIEW_CONTRACT_DRY_RUN_HEAVY_BATCH_V0"
