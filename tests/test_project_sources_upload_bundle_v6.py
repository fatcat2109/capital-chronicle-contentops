...
def test_metadata_integrity_and_hardenings(tmp_path):
    ...
    assert packet["task_label"] == "TASK_CONTENTOPS_V6_AI_PRODUCTION_CORE_HEAVY_BATCH_V0"
    ...
    assert packet["next_recommended_task"] == "TASK_CONTENTOPS_V6_PLATFORM_CONTENT_GENERATORS_AND_THREAD_CONTINUATION_HEAVY_BATCH_V0"
