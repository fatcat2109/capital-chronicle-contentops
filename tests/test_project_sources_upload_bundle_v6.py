...
def test_metadata_integrity_and_hardenings(tmp_path):
    ...
    assert packet["task_label"] == "TASK_CONTENTOPS_V6_SOURCE_PACK_VERIFICATION_UI_AND_OPERATOR_RESEARCH_CHECKLIST_HEAVY_BATCH_V0"
    ...
    assert packet["next_recommended_task"] == "TASK_CONTENTOPS_V6_VERIFIED_SOURCE_PACK_IMPORT_AND_REVALIDATION_DRY_RUN_HEAVY_BATCH_V0"
