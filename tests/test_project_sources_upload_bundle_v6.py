...
def test_metadata_integrity_and_hardenings(tmp_path):
    ...
    assert packet["task_label"] == "TASK_CONTENTOPS_V6_CANONICAL_ARTICLE_STUDIO_APPROVED_DRAFT_PLACEHOLDER_BINDING_DRY_RUN_HEAVY_BATCH_V0"
    ...
    assert packet["next_recommended_task"] == "TASK_CONTENTOPS_V6_CANONICAL_ARTICLE_STUDIO_SOURCE_APPROVED_DRAFT_RENDERER_DRY_RUN_HEAVY_BATCH_V0"
