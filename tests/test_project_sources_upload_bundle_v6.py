...
def test_metadata_integrity_and_hardenings(tmp_path):
    ...
    assert packet["task_label"] == "TASK_CONTENTOPS_V6_PLATFORM_VARIANT_INPUT_CONTRACT_QUEUE_DRY_RUN_HEAVY_BATCH_V0"
    ...
    assert packet["next_recommended_task"] == "TASK_CONTENTOPS_V6_PLATFORM_VARIANT_RENDERER_BLOCKED_OUTPUT_DRY_RUN_HEAVY_BATCH_V0"
