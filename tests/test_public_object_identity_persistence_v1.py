...
def test_migrations_1_to_4_bytes_and_checksums_unchanged():
    ...
    # The canonical schema is now v5 while v1-v4 SQL is untouched.
    assert hist.CANONICAL_SCHEMA_VERSION == SCHEMA_VERSION == 5
    # Frozen historical dependency manifests must NOT reference migration v5.
    ...
    # The V3 manifest DOES carry migration v5.
